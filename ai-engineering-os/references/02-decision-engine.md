...
## Purpose
Structured decision-making framework for technology selection, architecture choices, and design decisions. Replaces intuition with repeatable, auditable processes.
